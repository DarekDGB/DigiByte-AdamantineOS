...
**License:** MIT (repo) — **Author:** DarekDGB
...
2. **Warning** — A written warning with consequences for continued behavior.
3. **Temporary Ban** — A temporary ban from interaction.
4. **Permanent Ban** — Permanent ban from any interaction.
